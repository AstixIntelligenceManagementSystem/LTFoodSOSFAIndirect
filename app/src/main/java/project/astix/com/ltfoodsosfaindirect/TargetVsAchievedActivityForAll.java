...
public class TargetVsAchievedActivityForAll extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            Toast.makeText(TargetVsAchievedActivityForAll.this, "Your device has no Data Connection. \n Please ensure Internet is accessible to Continue.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void setUpVariable()
    {
        ...
        but_back.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View arg0)
            {
                ...
                {
                    Intent ide=new Intent(TargetVsAchievedActivityForAll.this,DetailReportSummaryActivityForAll.class);
    ...
    private class GetSKUWiseSummaryForDay extends AsyncTask<Void, Void, Void>
    {
        ...
        ProgressDialog pDialogGetStores=new ProgressDialog(TargetVsAchievedActivityForAll.this);
        ...
        protected Void doInBackground(Void... args)
        {
            ...
            try
            {
                newservice = newservice.getCallfnGetActualVsTargetReport(TargetVsAchievedActivityForAll.this,  imei, fDate);
