...
public class DistributorEntryActivity extends Activity {
    ...
    public void customHeader() {
        ...
        //tv_heading.setText("Distributor Stock Entry");
        ...
        img_back_Btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DayStartActivity.flgDistributorSelectedFromDropdown == 1) {
                    ...
                    DayStartActivity.flgDistributorSelectedFromDropdown = 0;
                    ...
                    Intent intent = new Intent(DistributorEntryActivity.this, DistributorCheckInForStock.class);
                    intent.putExtra("imei", imei);
                    intent.putExtra("fDate", fDate);
                    intent.putExtra("DistributorName", globalDistributorName);
    ...
    private void loadActivity() {
        {
            ...
            globalDistributorName = intent.getStringExtra("DistributorName");
            ...
            txt_distrbtrName = (TextView) findViewById(R.id.txt_distrbtrName);
                        ...
                        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    flgSODistributorStocktaken = dbengine.fnCheckflgSODistributorFirstVisit(DistribtrId_Global, DistributorNodeType_Global);
                                    saveDistributorStockInTable();
                                    int flgchecktblDistributorSavedData = 0;

                                    flgchecktblDistributorSavedData = dbengine.fnflgchecktblDistributorSavedData(DistribtrId_Global, DistributorNodeType_Global);
                                    DayStartActivity.flgDistributorSelectedFromDropdown = 0;
                                    if (flgSODistributorStocktaken == 0)//Stock is Reruired
                                    {

                                        if (flgchecktblDistributorSavedData == 0) {
                                            //Alert Please Satke the Stock Fisrt

                                            showAlertForEveryOne("Please take the Stock First");
                                        } else {
            ...
            spinner_for_filter.setOnItemSelectedListener(new OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (text.equals("Select Distributor")) {
                        ...
                        LLparentOfInPcsCs.setVisibility(View.GONE);
    ...
    public void getStockDetailByDistributorName() {
        ...
        if (DbrArray.contains(globalDistributorName)) {
            ...
            txt_distrbtrName.setText(globalDistributorName);
        }
    }
        ...
        try {
            if (lLayout_main.getChildCount() > 0) {
                ...
                for (Map.Entry<String, String> entry : HmapSavedData.entrySet()) {
                    ...
                    Log.d(TAG,""+dbengine.savetblDistributorSavedData(header, Short_name, pID, Date, Et_value, DistID, DistNodeType, ProductNodeType, StockDate, Sstat, EntryType, StockPcsCaseType));

                    //System.out.println("SAVED DATA :"+header+" "+Short_name+" "+pID+" "+Date+" "+Et_value+" "+DistribtrId_Global+" "+Sstat);
                    dbengine.UpdateDistributorLastStockdate(String.valueOf(DistID), String.valueOf(DistNodeType), StockDate);
                    dbengine.close();
                }
            }
    ...
    private static final String TAG = DistributorEntryActivity.class.getSimpleName();
    ...
    public void fnGetDistributorList() {
        ...
        adapter = new ArrayAdapter<String>(DistributorEntryActivity.this, R.layout.initial_spinner_text, DbrArray);
...
*/
    ...
    private class FullSyncDataNow extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                int checkNoFilesInCheckIn = dbengine.counttblDistributorCheckinData();
                if (checkNoFiles == 1 || checkNoFilesInCheckIn == 1) {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (isOnline()) {
                try {
                    ...
                    Intent syncIntent = new Intent(DistributorEntryActivity.this, SyncMstrCheckIN.class);
            ...
            if (AllFilesName.length > 0) {
                ...
                for (int vdo = 0; vdo < AllFilesName.length; vdo++) {
                    ...
                    if (fileUri.contains(".zip")) {
                        ...
                        String f1 = Environment.getExternalStorageDirectory() + "/" + CommonInfo.DistributorXMLFolder + "/" + fileUri;
    ...
    public void showAlertForEveryOne(String msg) {
        ...
        android.support.v7.app.AlertDialog.Builder alertDialogNoConn = new android.support.v7.app.AlertDialog.Builder(DistributorEntryActivity.this);
    ...
    void openDSRTrackerAlert() {
        final android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(DistributorEntryActivity.this);
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        btn_proceed.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rb_dataReport.isChecked()) {
                    Intent i = new Intent(DistributorEntryActivity.this, WebViewDSRDataReportActivity.class);
                    startActivity(i);

                } else if (rb_onMap.isChecked()) {
                    Intent i = new Intent(DistributorEntryActivity.this, WebViewDSRTrackerActivity.class);
                    startActivity(i);
