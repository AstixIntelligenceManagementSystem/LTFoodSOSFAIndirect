...
public class StoreWiseFragmentOneTab<Context> extends Fragment 
{
	...
	private void intializeFields() 
	{
		...
		total_ValAfterTax.setText(""+ValAfterTax.intValue());
			...
			TextView avg_Rate=(TextView)rootView.findViewById(R.id.avg_Rate);
			/*Double avg_RateDouble=Double.parseDouble(a10);
			avg_RateDouble=Double.parseDouble(new DecimalFormat("##.##").format(avg_RateDouble));*/
			if(a10.equals("NA")){
				a10="";
			}
			avg_Rate.setText(""+a10);

			TextView order_Qty=(TextView)rootView.findViewById(R.id.order_Qty);
			/*Double order_QtyDouble=Double.parseDouble(a11);
			order_QtyDouble=Double.parseDouble(new DecimalFormat("##.##").format(order_QtyDouble));*/
			if(a11.equals("NA")){
				a11="";
			}
			order_Qty.setText(""+a11);

			TextView free_Qty=(TextView)rootView.findViewById(R.id.free_Qty);
			/*Double free_QtyDouble=Double.parseDouble(a12);
			free_QtyDouble=Double.parseDouble(new DecimalFormat("##.##").format(free_QtyDouble));*/
			if(a12.equals("NA")){
				a12="";
			}
			free_Qty.setText(""+a12);
		...
		for(int i=1;i<AllDataContainer.length;i++)
		{
			...
			TextView txt_avg_Rate=(TextView) view.findViewById(R.id.txt_avg_Rate);
			Double txt_avg_RateDouble=Double.parseDouble(s10);
			txt_avg_RateDouble=Double.parseDouble(new DecimalFormat("##.##").format(txt_avg_RateDouble));

			if(s10.equals("NA")){
				s10="";
			}
			txt_avg_Rate.setText(""+s10);

			TextView txt_OrderQty=(TextView) view.findViewById(R.id.txt_OrderQty);
			Double txt_OrderQtyDouble=Double.parseDouble(s11);
			txt_OrderQtyDouble=Double.parseDouble(new DecimalFormat("##.##").format(txt_OrderQtyDouble));
			if(s11.equals("NA")){
				s11="";
			}

			txt_OrderQty.setText(""+s11);

			TextView txt_FreeQty=(TextView) view.findViewById(R.id.txt_FreeQty);
			Double txt_FreeQtyDouble=Double.parseDouble(s12);
			txt_FreeQtyDouble=Double.parseDouble(new DecimalFormat("##.##").format(txt_FreeQtyDouble));
			if(s12.equals("NA")){
				s12="";
			}
			txt_FreeQty.setText(""+s12);
