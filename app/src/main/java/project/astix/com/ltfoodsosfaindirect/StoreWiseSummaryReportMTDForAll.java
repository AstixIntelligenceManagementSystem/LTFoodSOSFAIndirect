    ...
    private void intializeFields()
    {
        ...
        if(AllDataContainer.length>0)
        {
     	...
     	/*initialValues.put("AutoId", AutoId);
            ...
            TextView avg_Rate=(TextView)findViewById(R.id.avg_Rate);
            ...
            TextView order_Qty=(TextView)findViewById(R.id.order_Qty);
            ...
            TextView free_Qty=(TextView)findViewById(R.id.free_Qty);
